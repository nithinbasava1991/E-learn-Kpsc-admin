...
import { fetchSuccessStory } from 'views/API/DashboardApi';
...
const ViewAllSuccessStories = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await fetchSuccessStory(headers);
...
export default ViewAllSuccessStories;

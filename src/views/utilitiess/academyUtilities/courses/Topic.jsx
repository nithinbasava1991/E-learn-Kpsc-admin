...
import { fetchAcademyModules, fetchAcademyTopics } from 'views/API/kpscApi';
...
const UpSkillTopics = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await fetchAcademyTopics(headers);
      ...
      if (fetchedData) {
        const tableData = fetchedData.map((p) => ({
          ...
          moduleName: p.academicModuleDtoList ? p.academicModuleDtoList.moduleName : 'No Module Name',
          videoUrl: p.videoUrl,
